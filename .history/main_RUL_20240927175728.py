...
class Train():
    def __init__(self, args):
        data_iter = CMPDataIter_graph('../data/CMAPSSData/',
    ...
    def Prediction_training(self):
        ...
        return RMSE.detach().cpu().numpy(), score.detach().cpu().numpy(), \
                prediction.detach().cpu().numpy(), train_label_sample.detach().cpu().numpy()
