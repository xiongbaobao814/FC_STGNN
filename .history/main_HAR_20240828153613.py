        ...
        for i in range(epoch):
            ...
            if i % self.args.show_interval == 0:
                ...
                if accu_val > cross_accu:
                    ...
                    real_.append(0)
            print(i)
        print(len(test_accu_), len(prediction_), len(real_))
        print(test_accu_, len(prediction_), len(real_))
        print(epoch)
        combined_array = np.column_stack((np.array(test_accu_), np.array(prediction_), np.array(real_)))
