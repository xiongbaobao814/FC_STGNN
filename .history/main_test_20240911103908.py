...
from data_loader_test import data_generator, data_provider_ETT


class Train():
    def __init__(self, args):
        self.train, self.valid, self.test = data_generator_ETT('../../all_datasets/ETT-small/ETTm1.csv', args=args)
